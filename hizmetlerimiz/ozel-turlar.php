...
<section>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-6">The most happiest time of the day!. Morbi sagittis, sem quis lacinia
                        faucibus, orci ipsum gravida tortor, vel interdum mi sapien ut justo. Nulla varius
                        consequat magna, id molestie ipsum volutpat quis. A true story, that never
                    ...
                    <div class="col-lg-6">Pellentesque ipsum erat, facilisis ut venenatis eu, sodales vel dolor.
                        The most happiest time of the day!. Morbi sagittis, sem quis lacinia faucibus, orci
                        ipsum gravida tortor, vel interdum mi sapien ut justo. Nulla varius
                        consequat magna, id molestie ipsum volutpat quis. A true story, that never been told!.
                        Fusce id mi diam, non ornare orci. Pellentesque ipsum erat, facilisis ut venenatis eu,
                        sodales vel dolor. Pellentesque ipsum erat, facilisis
                        ut venenatis eu, sodales vel dolor. <br> <br>The most happiest time of the day!. Morbi
                        sagittis, sem quis lacinia faucibus, orci ipsum gravida tortor, vel interdum mi sapien
                        ut justo. Nulla varius consequat magna, id molestie
                        ipsum volut.</div>
    ...
    <div class="row">
        <div style="background-color:#917d5d" class="col-lg-4">
            ...
            <span>The most happiest time of the day!. Morbi sagittis, sem quis lacinia faucibus, orci ipsum
                ...
                volutpat quis. A true story, that never been told!. </span>
        </div>
    ...
    <div class="container">
        ...
        <div class="row team-members team-members-shadow m-b-40">
            ...
            <div class="col-lg-3">
                <div class="team-member">
                    <div class="team-image">
                        <img src="<?php echo BASE_URL; ?>/assets/images/team/7.jpg">
                    </div>
                    <div class="team-desc">
                        <h3>Ariol Doe</h3>
                        <span>Software Developer</span>
            ...
            <div class="col-lg-3">
                <div class="team-member">
                    <div class="team-image">
                        <img src="<?php echo BASE_URL; ?>/assets/images/team/8.jpg">
                    </div>
                    <div class="team-desc">
                        <h3>Emma Ross</h3>
                        <span>Software Developer</span>
            ...
            <div class="col-lg-3">
                <div class="team-member">
                    <div class="team-image">
                        <img src="<?php echo BASE_URL; ?>/assets/images/team/9.jpg">
                    </div>
                    <div class="team-desc">
                        <h3>Victor Loda</h3>
                        <span>Software Developer</span>
