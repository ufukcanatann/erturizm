...
!(function (i, h, m, e, d, k, f) {
    ...
    var g = (i.$Jease$ = {
        ...
        $InOutElastic: function (a) {
            ...
            var b = 0.45,
                d = 0.1125;
            return (a *= 2) < 1 ? -0.5 * c.z(2, 10 * (a -= 1)) * c.eb(((a - d) * 2 * c.q) / b) : c.z(2, -10 * (a -= 1)) * c.eb(((a - d) * 2 * c.q) / b) * 0.5 + 1;
        },
        $InBack: function (a) {
            var b = 1.70158;
            return a * a * ((b + 1) * a - b);
    ...
    var b = (i.$Jssor$ = new (function () {
        ...
        function z(i, u, h, M, o) {
            ...
            function T(c) {
                var d = V[c] || {};
                return b.B({}, h, { $Easing: F[c] || F.mc || e, zd: Y[c] || e, Yc: d, $During: X[c] || e, $Round: Z[c] || e, mf: d.rd, td: a.We(s) ? s : s && s[c], je: 0 });
            }
            function t(a) {
    ...
    var u = (i.$JssorSlideshowFormations$ = new (function () {
        ...
        i.$FormationRandom = function (d) {
            for (var e = [], a, b = 0; b < d.$Rows; b++) for (a = 0; a < d.$Cols; a++) h(e, c.H(1e5 * c.Tc()) % 13, [b, a]);
            return e;
        };
        i.$FormationCircle = function (d) {
            for (var e = d.$Cols || 1, f = d.$Rows || 1, g = [], a, i = e / 2 - 0.5, j = f / 2 - 0.5, b = 0; b < e; b++) for (a = 0; a < f; a++) h(g, c.$Round(c.Hb(c.z(b - i, 2) + c.z(a - j, 2))), [a, b]);
            return g;
        };
    ...
    i.$JssorSlideshowRunner$ = function (n, q, o, r, w, v) {
        ...
        function j(f, e) {
            ...
            a.Uf = function (c, b) {
                ...
                if (!a.Dc[f]) {
                    a.Dc[f] = { w: c, h: b };
                    for (var d = 0; d < a.$Cols; d++) for (var e = 0; e < a.$Rows; e++) a.Dc[f][e + "," + d] = { y: e * b, t: d * c + c, m: e * b + b, x: d * c };
                }
                return a.Dc[f];
            };
            if (a.$Brother) {
